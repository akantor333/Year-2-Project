...
public class OrderItem extends Model {
    ...
    @ManyToOne
    private PhysWorks physworks;
    // Default constructor
    public  OrderItem() {
    }
    public OrderItem(PhysWorks ios) {
            physworks = ios;
            quantity = 1;
            price = ios.getPrice();
    }
   ...
   //Generic query helper
    ...
    public PhysWorks getPhysWorks() {
        return physworks;
    }
    public void setPhysWorks(PhysWorks physworks) {
        this.physworks = physworks;
    }
}